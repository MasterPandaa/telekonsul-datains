            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    @php
                        ...
                        // Menentukan range halaman yang akan ditampilkan (maksimal 5)
                    ...
                    {{-- Tampilkan "..." jika start page > 1 --}}
                    @if($startPage > 1)
                        <a href="{{ $paginator->url(1) }}" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 hover:text-gray-500 focus:z-10 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                            1
                        </a>
                        @if($startPage > 2)
                            <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5">
                                ...
                            </span>
                        @endif
                    @endif
                    ...
                    {{-- Tampilkan "..." jika end page < last page --}}
                    @if($endPage < $lastPage)
