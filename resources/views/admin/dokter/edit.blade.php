                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="h-16 w-16 rounded-full overflow-hidden bg-gray-100 border">
                            <img id="foto-preview" src="{{ $dokter->foto_url }}" alt="{{ $dokter->nama }}" class="h-full w-full object-cover cursor-pointer" onclick="openFotoUploadModal()">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <div class="mt-2 px-7 py-3">
                            <div class="w-40 h-40 mx-auto bg-gray-200 mb-4 overflow-hidden rounded-full">
                                <img id="foto-preview-modal" src="{{ $dokter->foto_url }}" alt="Preview" class="w-full h-full object-cover">
                            </div>
                            <div class="mt-3">
