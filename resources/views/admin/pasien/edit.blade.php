...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-6">
        ...
        <form action="{{ route('admin.pasien.update', $pasien->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="h-16 w-16 rounded-full overflow-hidden bg-gray-100 border">
                            <img id="foto-preview" src="{{ $pasien->foto_url }}" alt="{{ $pasien->nama }}" class="h-full w-full object-cover cursor-pointer" onclick="openFotoUploadModal()">
                        </div>
                        <div class="flex-1">
                    ...
                    <div class="mt-3 text-center">
                        ...
                        <div class="mt-2 px-7 py-3">
                            <div class="w-40 h-40 mx-auto bg-gray-200 mb-4 overflow-hidden rounded-full">
                                <img id="foto-preview-modal" src="{{ $pasien->foto_url }}" alt="Preview" class="w-full h-full object-cover">
                            </div>
                            <div class="mt-3">
