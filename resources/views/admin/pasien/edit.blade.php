    ...
    <div class="p-6">
        <div class="bg-blue-50 border border-blue-100 rounded-lg p-4 text-sm text-blue-800 mb-6">
            ...
            <ul class="list-disc list-inside space-y-1">
                ...
                <li>Password opsional: minimal 8 karakter serta kombinasi huruf besar, huruf kecil, dan angka.</li>
            </ul>
        </div>
        ...
        <form action="{{ route('admin.pasien.update', $pasien->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', optional($pasien->tanggal_lahir)->format('Y-m-d')) }}"
