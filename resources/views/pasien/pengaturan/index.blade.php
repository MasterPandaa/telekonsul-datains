...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('pasien.dashboard') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <form method="POST" action="{{ route('pasien.pengaturan.update') }}" class="px-6 py-5 space-y-6">
                @csrf
