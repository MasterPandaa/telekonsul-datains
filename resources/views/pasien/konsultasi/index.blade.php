                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-full object-cover bg-gray-100" src="{{ $item->dokter->dokter->foto_url ?? asset('img/default.jpg') }}" alt="{{ $item->dokter->name ?? 'Dokter' }}">
                                </div>
                                <div class="ml-4">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-full object-cover bg-gray-100" src="{{ $item->dokter->dokter->foto_url ?? asset('img/BW_ASSRI.png') }}" alt="{{ $item->dokter->name ?? 'Dokter' }}">
                                </div>
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900">{{ $item->dokter->name ?? '-' }}</div>
                                </div>
