...
<aside class="w-64 bg-white shadow-lg flex flex-col py-6 px-4 min-h-screen hidden md:flex">
    ...
    <nav class="flex-1">
        ...
        <ul class="space-y-1">
            <li>
                <a href="{{ route('dokter.dashboard') }}" class="flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 transition @if(request()->routeIs('dokter.dashboard')) bg-blue-100 font-medium text-blue-700 @endif">
        ...
        <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-6 mb-2 px-4">Konsultasi</div>
        <ul class="space-y-1">
            <li>
                <a href="{{ route('dokter.konsultasi.index') }}" class="flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 transition @if(request()->routeIs('dokter.konsultasi.*')) bg-blue-100 font-medium text-blue-700 @endif">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('dokter.riwayat.index') }}" class="flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 transition @if(request()->routeIs('dokter.riwayat.*')) bg-blue-100 font-medium text-blue-700 @endif">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="space-y-1">
            <li>
                <a href="{{ route('dokter.profil.index') }}" class="flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 transition @if(request()->routeIs('dokter.profil.*')) bg-blue-100 font-medium text-blue-700 @endif">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('dokter.pengaturan.index') }}" class="flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 transition @if(request()->routeIs('dokter.pengaturan.*')) bg-blue-100 font-medium text-blue-700 @endif">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
<div id="sidebar-mobile" class="fixed inset-0 z-50 hidden">
    ...
    <div class="absolute inset-y-0 left-0 w-64 bg-white shadow-lg py-6 px-4 overflow-y-auto">
        ...
        <nav class="flex-1">
            ...
            <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mt-6 mb-2 px-2">Konsultasi</div>
            <ul class="space-y-1">
                <li>
                    <a href="{{ route('dokter.konsultasi.index') }}" class="flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 transition @if(request()->routeIs('dokter.konsultasi.*')) bg-blue-100 font-medium text-blue-700 @endif">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
