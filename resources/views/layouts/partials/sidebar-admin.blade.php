<aside class="w-64 bg-white shadow-lg flex flex-col py-6 px-4 min-h-screen hidden md:flex">
    ...
    <nav class="flex-1">
        ...
        <ul class="space-y-1">
            <li>
                <a href="{{ route('admin.dokter.index') }}" class="flex items-center px-4 py-2.5 rounded-lg text-gray-700 hover:bg-blue-50 transition @if(request()->routeIs('admin.dokter.*')) bg-blue-100 font-medium text-blue-700 @endif">
