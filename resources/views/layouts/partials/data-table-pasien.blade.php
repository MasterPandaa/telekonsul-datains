@props(['title', 'createRoute' => null, 'createLabel' => 'Buat Janji', 'columns' => [], 'data' => [], 'pagination' => null])
...
<div class="bg-white rounded-lg shadow-md overflow-hidden">
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            <thead>
                <tr class="bg-gradient-to-r from-blue-50 to-indigo-50 text-left text-xs font-medium text-indigo-700 uppercase tracking-wider">
