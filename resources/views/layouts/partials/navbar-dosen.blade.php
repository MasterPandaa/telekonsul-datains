<!-- Mobile navigation -->
<div class="md:hidden bg-white border-b" id="sidebar-mobile">
    <div class="px-2 py-3 space-y-1">
        <a href="{{ route('dashboard') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 @if(request()->routeIs('dashboard')) bg-blue-100 text-blue-700 @endif">
            Dashboard
        </a>
        <a href="{{ route('dosen.penilaian.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 @if(request()->routeIs('dosen.penilaian.*')) bg-blue-100 text-blue-700 @endif">
            Penilaian
        </a>
        <a href="{{ route('dosen.rekap.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 @if(request()->routeIs('dosen.rekap.*')) bg-blue-100 text-blue-700 @endif">
            Rekap Data
        </a>
        <a href="{{ route('dosen.profil.index') }}" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:bg-gray-100 @if(request()->routeIs('dosen.profil.*')) bg-blue-100 text-blue-700 @endif">
            Profil Saya
        </a>
    </div>
</div>
        ...
        <div class="relative" x-data="{ isOpen: false }">
            ...
            <div x-show="isOpen" 
                ...
                <div class="px-4 py-2 border-b border-gray-100">
                    <p class="text-sm font-medium text-gray-800">{{ $dosen && $dosen->nama ? $dosen->nama : Auth::user()->name }}</p>
                    <p class="text-xs text-gray-500">Dosen</p>
                </div>
                <a href="{{ route('dosen.profil.index') }}" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600 transition-colors duration-150">
    ...
    function notificationSystem() {
        return {
            ...
            updateClock() {
                ...
                document.getElementById('realtime-clock').textContent = formattedDate;
            }
        };
    }
</script>
