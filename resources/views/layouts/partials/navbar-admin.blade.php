...
<div class="md:hidden fixed bottom-0 left-0 right-0 z-20 bg-white border-t shadow">
    <div class="grid grid-cols-4 gap-1">
        ...
        <a href="{{ route('admin.dokter.index') }}" class="flex flex-col items-center justify-center py-3 @if(request()->routeIs('admin.dokter.*')) text-blue-600 @else text-gray-600 @endif">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
