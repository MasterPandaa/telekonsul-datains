...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 lg:col-span-1">
        <div class="flex flex-col items-center text-center space-y-4">
            <div class="w-24 h-24 rounded-full overflow-hidden border-4 border-blue-50 shadow">
                <img src="https://ui-avatars.com/api/?name={{ urlencode($dokter->nama ?? 'Dokter') }}&background=4F46E5&color=fff" alt="{{ $dokter->nama ?? 'Dokter' }}" class="w-full h-full object-cover">
            </div>
            <div class="space-y-1">
