            ...
            <tbody class="bg-white divide-y divide-gray-200" id="belum-dinilai-tbody">
                ...
                <tr class="hover:bg-gray-50 transition konsultasi-row" 
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10">
                                <img class="h-10 w-10 rounded-full object-cover bg-gray-100" src="{{ $konsultasi->dokter->dokter->foto_url ?? asset('img/BW_ASSRI.png') }}" alt="{{ $konsultasi->dokter->name }}">
                            </div>
                            <div class="ml-4">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10">
                                <img class="h-10 w-10 rounded-full object-cover bg-gray-100" src="{{ $konsultasi->pasien->foto_url ?? asset('img/BW_ASSRI.png') }}" alt="{{ $konsultasi->pasien->nama ?? 'Tidak ada nama' }}">
                            </div>
                            <div class="ml-4">
