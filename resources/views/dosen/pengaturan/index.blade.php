...
<div class="mb-6">
    ...
    <p class="text-sm text-gray-600">Kelola keamanan akun dosen tanpa meninggalkan dashboard.</p>
</div>
    ...
    <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div>
                ...
                <p class="text-sm text-gray-500">Perkuat keamanan akun dengan mengganti password secara berkala.</p>
            </div>
        ...
        <form method="POST" action="{{ route('dosen.pengaturan.update') }}" class="px-6 py-6 space-y-6">
            @csrf
