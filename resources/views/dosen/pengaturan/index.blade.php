...
<div class="mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Pengaturan Password</h1>
    <p class="text-sm text-gray-600">Kelola keamanan akun Anda dengan mengubah password secara berkala</p>
</div>
...
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    ...
    <form method="POST" action="{{ route('dosen.pengaturan.update') }}" class="px-6 py-5 space-y-6">
        @csrf
        ...
        <div>
            ...
            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
            @else
            <p class="mt-2 text-xs text-gray-500">Password harus terdiri dari minimal 6 karakter dan gabungan huruf dan angka.</p>
            @enderror
        </div>
