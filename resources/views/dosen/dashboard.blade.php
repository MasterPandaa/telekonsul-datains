                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-full object-cover bg-gray-100" src="{{ $konsultasi->pasien->foto_url ?? \App\Support\ProfilePhoto::getDefaultUrl() }}" alt="{{ $konsultasi->pasien->nama }}">
                                </div>
                                <div class="ml-4">
