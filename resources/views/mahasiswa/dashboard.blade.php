...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
        ...
        <div class="mt-4">
            <a href="{{ route('mahasiswa.konsultasi.index') }}" class="text-blue-500 hover:text-blue-600 text-sm font-medium">Lihat Detail &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
        ...
        <div class="mt-4">
            <a href="{{ route('mahasiswa.riwayat.index') }}" class="text-green-500 hover:text-green-600 text-sm font-medium">Lihat Detail &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
        ...
        <div class="mt-4">
            <a href="{{ route('mahasiswa.riwayat.index') }}" class="text-yellow-500 hover:text-yellow-600 text-sm font-medium">Lihat Detail &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
        ...
        <div class="mt-4">
            <a href="{{ route('mahasiswa.riwayat.index') }}" class="text-purple-500 hover:text-purple-600 text-sm font-medium">Lihat Detail &rarr;</a>
        </div>
    </div>
</div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name={{ urlencode($jadwal['pasien_nama']) }}&background=4F46E5&color=fff" alt="{{ $jadwal['pasien_nama'] }}">
                                </div>
                                <div class="ml-4">
